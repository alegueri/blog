  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <article className="bg-white border border-stone-200 rounded-2xl overflow-hidden shadow-sm">
        {/* Top accent */}
        <div className="h-1 bg-gradient-to-r from-indigo-400 via-violet-400 to-indigo-300" />
        ...
        <div className="px-10 pt-10 pb-8">
          ...
          {/* Icon */}
          {post.icon && (
            <div className="text-5xl mb-5 leading-none">{post.icon}</div>
          )}
          ...
          {/* Excerpt */}
          <p className="text-lg text-stone-500 leading-relaxed mb-7 border-l-2 border-indigo-200 pl-4 italic">
            {post.excerpt}
          </p>

          {/* Byline */}
          <div className="flex items-center justify-between" style={{ fontFamily: 'var(--font-inter), sans-serif' }}>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-white text-xs font-bold">
                AG
              </div>
              <div>
                <p className="text-sm font-medium text-gray-800">Ale</p>
            ...
            {isAdmin && (
              <div className="flex items-center gap-3">
                <Link
                  ...
                  className="flex items-center gap-1 text-xs text-stone-400 hover:text-indigo-600 transition-colors"
                  title="Edit post"
                >
        ...
        {/* Divider */}
        <div className="mx-10 border-t border-stone-100" />

        {/* Content */}
        <div
          className="px-10 py-10 prose prose-stone prose-lg max-w-none
            prose-headings:font-bold prose-headings:tracking-tight
            prose-a:text-indigo-600 prose-a:no-underline hover:prose-a:underline
            prose-code:text-indigo-600 prose-code:bg-indigo-50 prose-code:rounded prose-code:px-1 prose-code:text-sm
            prose-pre:bg-gray-900 prose-pre:rounded-xl
            prose-blockquote:border-l-indigo-300 prose-blockquote:text-stone-500 prose-blockquote:italic
